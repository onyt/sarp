...
local function ChangeJobVGUI()
	...
	if not F4MenuTabs or not F4MenuTabs:IsValid() then
		...
		F4MenuTabs:AddSheet("Character", F4Tabs[1], "gui/silkicons/plugin", false, false)
		F4MenuTabs:AddSheet("Jobs", F4Tabs[2], "gui/silkicons/arrow_refresh", false, false)
		F4MenuTabs:AddSheet("Items", F4Tabs[3], "gui/silkicons/application_view_tile", false, false)
